                            ...
                            <form action="{{ route('member.index') }}" method="get">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="nama..." id="search-input" name="name"
                                            value="{{ request('name') }}"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[200px] dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30" />
                                            ...
                                            @foreach ($members as $member)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <form
                                                                action="{{ route('member.delete', ['id' => $member['kode_member']]) }}"
                                                            ...
                                                            <a href="{{ route('member.show', ['id' => $member['kode_member']]) }}"
                                                            ...
                                                            <a href="{{ route('member.print', ['id' => $member['kode_member']]) }}"
                                                                class="inline-flex items-center gap-2 rounded-lg bg-warning-500 px-2 py-1.5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-warning-600 ">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                    viewBox="0 0 24 24" stroke-width="1.5"
                                                                    stroke="currentColor" class="size-6">
                                                                    <path stroke-linecap="round"
