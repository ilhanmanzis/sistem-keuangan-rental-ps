            ...
            <div class="space-y-5 sm:space-y-6">
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                                                ...
                                                <select name="user"
                                                    ...
                                                    @foreach ($karyawans as $karyawan)
                                                        <option value="{{ $karyawan['id'] }}"
                                                            {{ request('user') == $karyawan['id'] ? 'selected' : '' }}
                                                            class="text-gray-700 dark:bg-gray-900 dark:text-gray-400 ">
                                                            {{ $karyawan['name'] }}
                                                        </option>
                                                    @endforeach
                        ...
                        <div class="p-2 border-t border-gray-100 dark:border-gray-800 sm:p-2">
                            <!-- ====== Table Six Start -->
                            <div
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2"
                                                    class="border border-gray-100 dark:border-gray-800 px-5 py-3 sm:px-6">
                                                ...
                                                <td class="px-5 py-3 sm:px-6 text-center" colspan="3">
                                            ...
                                            <tr class="border border-gray-100 dark:border-gray-800">
                                            ...
                                            @foreach ($transaksis as $transaksi)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <form
                                                                action="{{ route('pemasukan.delete', ['id' => $transaksi['id_transaksi']]) }}"
                                                            ...
                                                            <a href="{{ route('pemasukan.show', ['id' => $transaksi['id_transaksi']]) }}"
                                                            ...
                                                            <a href="{{ route('pemasukan.print', ['id' => $transaksi['id_transaksi']]) }}"
