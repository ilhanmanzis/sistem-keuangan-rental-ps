<x-layout>
    ...
    <div class="p-8">
        ...
        <!-- Breadcrumb Start -->
        <div x-data="{ pageName: `Edit Device` }">
        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <form action="{{ route('device.update', ['id' => $device['id_device']]) }}" method="post">
                    @method('put')
                    @csrf
                    <!-- Elements -->
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ $device['harga_perjam'] }}" required
